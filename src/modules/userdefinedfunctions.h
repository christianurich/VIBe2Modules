...
inline void addCorineConstants(mu::Parser * p){
    ...
    mu::ContUrbanFabric = vibens::VIBe2::ContUrbanFabric;
    mu::DisContUrbanFabric= vibens::VIBe2::DisContUrbanFabric;
    mu:: RoadRailNetwork= vibens::VIBe2::RoadRailNetwork;
    mu::WaterBodies= vibens::VIBe2::WaterBodies;
    mu::AgriculturalAreas= vibens::VIBe2::AgriculturalAreas;
    mu::ForestsSemiNatural= vibens::VIBe2::ForestsSemiNatural;
