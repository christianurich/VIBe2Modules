...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 ..\..\lib\muparserd.lib /nologo /machine:i386 /out:"..\..\samples\example3\example3.exe" /subsystem:console /libpath:"..\..\lib" /debug
# ADD LINK32 ..\..\lib\muparserd.lib /nologo /machine:i386 /out:"..\..\samples\example3\example3.exe" /subsystem:console /libpath:"..\..\lib" /debug
