...
class VIBE_HELPER_DLL_EXPORT GUICellularAutomata : public QDialog
{
    Q_OBJECT

public:
    explicit GUICellularAutomata(vibens::Module * m ,QWidget *parent = 0);
    vibens::Module * getModule() {return this->m;}
    ~GUICellularAutomata();
